# ============================================================
# FILE 3: SHINY WEB APPLICATION
# Weather Prediction Dashboard — Americas
# Depends on: weather_scraped.rds + weather_transformed.rds
#   Run 01_data_scraping.R then 02_data_transformation.R first
# ============================================================
